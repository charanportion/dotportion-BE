...
import ExecutionLog from "/opt/nodejs/models/ExecutionLog.js";
...
// import ExecutionLog from "../layers/common/nodejs/models/ExecutionLog.js";
...
export const handler = async (event) => {
  try {
    logger.info("received Update Project event:", JSON.stringify(event));
